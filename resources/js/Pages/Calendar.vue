<template>
  <AppLayout>
    ...
    <div class="bg-white text-gray-900 min-h-screen relative flex flex-col items-center justify-start transition-all duration-500">
      <img
        id="background"
      ...
      <!-- Overlay for readability, adjusted to the full height of the screen -->
      <div class="absolute inset-0 "></div>
      
      <!-- Main Content -->
      <main class="relative z-10 py-12 bg-opacity-80 w-full">
